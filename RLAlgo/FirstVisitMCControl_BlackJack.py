...
def FirstVisitMCControl(numEpisodes):
	...
	for iteration in range(0,numEpisodes):
		...
		for (playerSum, dealerFaceUpCard, playerUsabilityAce), action in episode:
			...
			policy_Player[playerSum][dealerFaceUpCard][int(playerUsabilityAce)] = maxAction
			
	return Estimate_StateActionValue/count_StateActionVisited

def fig5_2():
	Estimate_StateActionValue = FirstVisitMCControl(500000)
